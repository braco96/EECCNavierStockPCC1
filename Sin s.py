...
def modificar_settings_y_ejecutar_acolite(madrid_muestra:Muestras, elevation:int):
    ...
    limit_str = '40.43918148084956,-4.258400981846755,40.539181481065874,-4.058400958233731'
    ...
    settings_content = settings_content.replace('${LIMIT}', limit_str)  # Reemplazar la clave limit con las coordenadas
